...
class Https implements Runnable {
    ...
    public Https(String scanUrl, String scanUser, String scanPass, String httpname, String encodedFile, String httpGET, Activity httpFile) {
    ...
    public void run() {
        try {
            ...
            connection = (HttpsURLConnection) new URL(scanUrl).openConnection();
            ...
            if (status == HttpURLConnection.HTTP_OK) {
                ...
                httpFile.runOnUiThread(() -> Toast.makeText(httpFile, "HTTPS: Данные отправлены!", Toast.LENGTH_SHORT).show());
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
